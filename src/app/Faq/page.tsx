    ...
    return(
        <div className="overflow-x-hidden">
               ...
               <div>
                ...
                <h1 className="text-center font-bold mt-[25px] pb-[11px] sm:text-[22px]">Questions Looks Here</h1>
                <p className="text-center text-nowrap text-[7px] sm:text-[9px] pb-[33px] md:text-[12px] text-[#4F4F4F] font-bold" >Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the </p>
